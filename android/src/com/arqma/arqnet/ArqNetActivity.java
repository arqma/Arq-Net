...
public class ArqNetActivity extends Activity {
	private static final String TAG = "arqnet-activity";
	private TextView textView;
	private static final String DefaultBootstrapURL = "https://seed.arqma.com/bootstrap.signed";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		System.loadLibrary("arqnetandroid");
	}
	...
	public void runArqnetService()
	{
		startService(new Intent(ArqNetActivity.this,
				ArqnetService.class));
	}
