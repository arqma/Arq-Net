...
startWinsock()
{
  ...
  ::CreateMutex(nullptr, FALSE, "arqnet_win32_daemon");
  return 0;
}
...
main(int argc, char *argv[])
{
  ...
  cxxopts::Options options("arqnet",
                           "ArqNET is a free, open source, private, "
  ...
  do
  {
    // do periodic non arqnet related tasks here
    if(ctx != nullptr)
    {
