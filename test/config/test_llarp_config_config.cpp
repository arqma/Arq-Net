...
contact-file=/home/arqnet/1/self.signed
# path to store transport private key
transport-privkey=/home/arqnet/1/transport.private
# path to store identity signing key
ident-privkey=/home/arqnet/1/identity.private
# encryption key for onion routing
encryption-privkey=/home/arqnet/1/encryption.private

# uncomment following line to set router nickname to 'arqnet'
netid=bunny
...
user=arqnet
group=arqnet
pidfile=/home/arqnet/1/arqnet.pid
...
add-node=/home/arqnet/1/bootstrap.signed

# snapps configuration section
[services]# uncomment next line to enable a snapp
#example-snapp=/home/arqnet/1/snapp-example.ini
...
ifaddr=10.101.0.1/16
  ...
  ASSERT_THAT(config.bootstrap.routers,
              ElementsAre("/home/arqnet/1/bootstrap.signed"));
}
