...
#define MyAppName "Arqnet"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Arqma Network"
#define MyAppURL "https://arqma.com"
#define MyAppExeName "arqnetui.exe"
...
OutputBaseFilename=arqnet-win32
Compression=lzma2/ultra64
SolidCompression=yes
VersionInfoVersion=1.0.0
VersionInfoCompany=Arqma Network
VersionInfoDescription=Arqnet for Microsoft® Windows® NT™
#ifndef RELEASE
VersionInfoTextVersion=1.0.0-dev-{#VCSRev}
VersionInfoProductTextVersion=1.0.0-dev-{#VCSRev}
#else
VersionInfoTextVersion=1.0.0
VersionInfoProductTextVersion=1.0.0 ({#Codename})
#endif
VersionInfoProductName=Arqnet
VersionInfoProductVersion=1.0.0
InternalCompressLevel=ultra64
MinVersion=0,5.0
ArchitecturesInstallIn64BitMode=x64
VersionInfoCopyright=Copyright 2025 Arqma Network / ©2018-2020 Loki Project
AppMutex=arqnet_win32_daemon,arqnet_qt5_ui,arqnet_dotnet_ui
...
#ifdef SINGLE_ARCH
Source: "{#DevPath}build\arqnet.exe"; DestDir: "{app}"; Flags: ignoreversion
; don't ship it, we don't have a public api yet!
;Source: "{#DevPath}build\libarqnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "dbghelp64.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}build\arqnet.exe"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
;Source: "{#DevPath}build\libarqnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
Source: "dbghelp32.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsWin64
Source: "{#DevPath}build64\arqnet.exe"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
;Source: "{#DevPath}build64\libarqnet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
Source: "dbghelp64.dll"; DestDir: "{app}"; DestName: "dbghelp.dll"; Flags: ignoreversion; Check: IsWin64
#endif
; UI has landed!
#ifndef RELEASE
Source: "{#DevPath}ui-win32\bin\debug\arqnetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\arqnetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\arqnetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}ui-win32\bin\release\arqnetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\arqnetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\arqnetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#endif
...
Source: "{#DevPath}build\arqnetctl.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion
Source: "arqnet-bootstrap.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "arqnet-qt5-ui.7z"; DestDir: "{app}"; Flags: ignoreversion deleteafterinstall; MinVersion: 0,6.0;
Source: "arqnet.ico"; DestDir: "{app}"; Flags: ignoreversion;
...
Source: "config_migration.bat"; DestDir: "{userappdata}\.arqnet"; Flags: deleteafterinstall; MinVersion: 0,6.0
...
Type: filesandordirs; Name: "{app}\arqnet-qt5-ui"; MinVersion: 0,6.0
Type: filesandordirs; Name: "{userappdata}\.arqnet"
...
begin
  ...
  if IsTaskSelected('migrateconfigs') then
    MsgBox('Arqnet JSON-RPC API endpoint enabled. Any custom configuration was retained in %APPDATA%\.arqnet\arqnet.old.ini.', mbInformation, MB_OK);
  end;
end;
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; OnlyBelowVersion: 0, 6.0; IconFilename: "{app}\arqnet.ico"
Name: "{group}\{#MyAppName}"; Filename: "{app}\arqnet-qt5-ui\arqnetui.exe"; MinVersion: 0, 6.0; IconFilename: "{app}\arqnet.ico"
Name: "{group}\{cm:ProgramOnTheWeb,{#MyAppName}}"; Filename: "{#MyAppURL}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; OnlyBelowVersion: 0,6.0; IconFilename: "{app}\arqnet.ico"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\arqnet-qt5-ui\arqnetui.exe"; Tasks: desktopicon; MinVersion: 0,6.0; IconFilename: "{app}\arqnet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; OnlyBelowVersion: 0, 6.1; IconFilename: "{app}\arqnet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\User Pinned\TaskBar\{#MyAppName}"; Filename: "{app}\arqnet-qt5-ui\arqnetui.exe"; Tasks: quicklaunchicon; MinVersion: 0, 6.1; IconFilename: "{app}\arqnet.ico"
...
Filename: "{app}\arqnet-qt5-ui\arqnetui.exe"; Flags: nowait postinstall skipifsilent; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; MinVersion: 0,6.0
...
Filename: "{tmp}\7z.exe"; Parameters: "x arqnet-qt5-ui.7z -aoa"; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated skipifdoesntexist; Description: "installing modern Qt5 UI"; StatusMsg: "Installing modern Qt5 UI..."; MinVersion: 0, 6.0;
Filename: "{app}\arqnet-bootstrap.exe"; Parameters:"-L https://seed.arqma.com/arqnet.signed --cacert rootcerts.pem -o ""{userappdata}\.arqnet\bootstrap.signed"""; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated; Description: "bootstrap dht"; StatusMsg: "Downloading initial RC..."
...
Filename: "{userappdata}\.arqnet\config_migration.bat"; WorkingDir: "{userappdata}\.arqnet"; Flags: runascurrentuser waituntilterminated; Description: "migrate existing config"; StatusMsg: "Migrating old configuration..."; MinVersion: 0,6.0; Tasks: migrateconfigs;